...
/* base.html.twig */
class __TwigTemplate_989dfecf934dcfcc8a87060409af5004261c4d743cd0719111ecefadcedc6617 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<html>
    ...
    <nav class=\"navbar navbar-expand-lg navbar-light bg-light\" style=\"background-color: #e3f2fd;\">
        <a class=\"navbar-brand\" href=\"#\">MyGarage</a>
...
<html>
    ...
    <nav class=\"navbar navbar-expand-lg navbar-light bg-light\" style=\"background-color: #e3f2fd;\">
        ...
        <div class=\"collapse navbar-collapse\" id=\"navbarText\">
            <ul class=\"navbar-nav mr-auto\">
                <li class=\"nav-item active\">
                    <a class=\"nav-link\" href=\"{{ path('user_index') }}\">Client</a>
                </li>
                <li class=\"nav-item\">
                    <a class=\"nav-link\" href=\"{{ path('vehicle_index') }}\">Voiture</a>
                </li>
                <li class=\"nav-item\">
                    <a class=\"nav-link\" href=\"{{ path('entretien_index') }}\">Intervention</a>
                </li>
            </ul>
            <span class=\"navbar-text\">
             {% if app.user %}
...
", "base.html.twig", "/home/rania/Symfony/symfony/templates/base.html.twig");
    }
}
