...
// Returns the private 'App\Repository\EntretienRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EntretienRepository.php';

return $this->privates['App\\Repository\\EntretienRepository'] = new \App\Repository\EntretienRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
